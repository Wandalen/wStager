...
function stageCancel1( test )
{
  ...
  function run2end()
  {
    ...
    test.identical( object.ready1.infoExport({ verbosity : 1 }), 'Consequence:: 1 / 0' );
    test.identical( object.ready2.infoExport({ verbosity : 1 }), 'Consequence:: 1 / 0' );
    test.identical( object.ready3.infoExport({ verbosity : 1 }), 'Consequence:: 1 / 0' );
...
function stageError2( test )
{
  ...
  function run1end( err, arg )
  {
    ...
    test.identical( object.ready1.infoExport({ verbosity : 1 }), 'Consequence:: 1 / 0' );
    test.identical( object.ready2.infoExport({ verbosity : 1 }), 'Consequence:: 1 / 0' );
    test.identical( object.ready3.infoExport({ verbosity : 1 }), 'Consequence:: 0 / 0' );
